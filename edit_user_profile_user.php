...
<?php
	...
	else if($result2->num_rows > 0)
	{
		...
		echo
			"<br>
			<div>
			<form method = 'POST' action='update_user_profile_user.php' onload = 'checkTel()'>
			<p align='right'>
			<button class = 'button' type='submit' id='sub'>Update Details</button>
				...
				<table width = 90%>
					<tr>
						...
						<th style='width:50%;'>
							<center><input type='text' style='font-family:Supercell;' name = 'uname' value = '$row[3]' required></center>
						</th>
					</tr>
					<tr>
						<td rowspan=6>
					...
					<tr>
						<td>
							<h3 style='font-family:Georgia;'>Email ID : <input type='text' style='font-family:Georgia;width:70%;' name = 'email' value = '$row[2]' required> </h3>
						</td>
					</tr>
					<tr>
						<td>
							<h3 style='font-family:Georgia;'>Contact No : <input type='text' style='font-family:Georgia;width:70%;' id = 'ph_no' name = 'ph_no' value = '$row[6]' onchange = 'checkTel()' required> </h3>
							<p style = 'color:white;' id = 'status'> </p>
						</td>
					</tr>
					<tr>
						<td>
							<h3 style='font-family:Georgia;'>Batch : $row[4]&ensp;(edit not available) </h3>
						</td>
					</tr>
					<tr>
						<td>
							<h3 style='font-family:Georgia;'>Section : <input type='text' style='font-family:Georgia;width:70%;' name = 'section' value = '$row[5]' required> </h3>
						</td>
					</tr>
					<tr>
						<td>
							<h3 style='font-family:Georgia;'>Department : <input type='text' style='font-family:Georgia;width:70%;' name = 'dept' value = '$row[7]' required> </h3>
						</td>
					</tr>
				</table>
				<br></form>
			</div><br>
			<form action = 'delete_user.php' method = 'POST' target = '_top'  onsubmit='return confirm(\"Are you sure? Your account will be deleted.\");'>
				<button class = 'button' id='del' type='submit'>Delete Account</button> <h5> Warning: This will delete your account </h5>
			</form>
			";
	}
?>
